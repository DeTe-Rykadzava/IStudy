...
public class CertificateController : BaseController
{
    ...
    public async Task<IActionResult> PutCertificate(CertificateDTO certificateDto)
    {
        try
        {
            ...
            {
                var ownerCertificate =
                    certificate.CertificateOwners.FirstOrDefault(x => x.CertificateOwnerUser.Id == owner.Owner.Id);
                // add
            ...
            foreach (var certificateOwner in certificate.CertificateOwners)
            {
                ...
                if (owner == null) _context.CertificateOwners.Remove(certificateOwner);
            }
